...
const Checkout = () => {
  ...
  const paymentSubmit = () => {
    if (!address1 || !address2 || !city || !country || !zipCode) {
     ...
     // Update local storage with updated orders
  ...
  // For eg if price is 1000 then
  // Shipping will be 0.1% of it
  ...
  return (
    <div className="w-full flex flex-col items-center py-8">
      ...
      <div
        className={`${styles.hero_button} w-[150px] 800px:w-[280px] mt-10`}
