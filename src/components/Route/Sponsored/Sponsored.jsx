...
const Sponsored = () => {
  return (
    <div className={`${styles.section} hidden sm:block bg-white py-10 px-5 mb-12 cursor-pointer rounded-xl relative `}>
        <div className='flex justify-between w-full absolute animate-marquee-infinite'>
