const styles = {
    ...
    header_button: 'w-[150px] bg-[#362a90fb] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    hero_button: 'w-[200px] bg-[#362a90fb] h-[50px] my-4 flex items-center justify-center  cursor-pointer',
